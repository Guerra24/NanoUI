...
package net.luxvacuos.nanoui.rendering.shaders;

import static net.luxvacuos.nanoui.rendering.GL.GL_COMPILE_STATUS;
import static net.luxvacuos.nanoui.rendering.GL.GL_FALSE;
import static net.luxvacuos.nanoui.rendering.GL.GL_FRAGMENT_SHADER;
import static net.luxvacuos.nanoui.rendering.GL.GL_GEOMETRY_SHADER;
import static net.luxvacuos.nanoui.rendering.GL.GL_VERTEX_SHADER;
import static net.luxvacuos.nanoui.rendering.GL.glAttachShader;
import static net.luxvacuos.nanoui.rendering.GL.glBindAttribLocation;
import static net.luxvacuos.nanoui.rendering.GL.glCompileShader;
import static net.luxvacuos.nanoui.rendering.GL.glCreateProgram;
import static net.luxvacuos.nanoui.rendering.GL.glCreateShader;
import static net.luxvacuos.nanoui.rendering.GL.glDeleteProgram;
import static net.luxvacuos.nanoui.rendering.GL.glDeleteShader;
import static net.luxvacuos.nanoui.rendering.GL.glDetachShader;
import static net.luxvacuos.nanoui.rendering.GL.glGetShaderInfoLog;
import static net.luxvacuos.nanoui.rendering.GL.glGetShaderi;
import static net.luxvacuos.nanoui.rendering.GL.glLinkProgram;
import static net.luxvacuos.nanoui.rendering.GL.glShaderSource;
import static net.luxvacuos.nanoui.rendering.GL.glUseProgram;
import static net.luxvacuos.nanoui.rendering.GL.glValidateProgram;
...
import net.luxvacuos.nanoui.rendering.shaders.data.Attribute;
import net.luxvacuos.nanoui.rendering.shaders.data.IUniform;
