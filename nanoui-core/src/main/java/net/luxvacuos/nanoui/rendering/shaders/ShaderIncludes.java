...
import net.luxvacuos.nanoui.core.exception.IncludeShaderException;
...
public final class ShaderIncludes {
	...
	public static void processIncludeFile(String name) {
		...
		try {
			filet = Application.class.getClassLoader().getResourceAsStream("assets/shaders/includes/" + name);
